...
create table Employee(ID varchar(60), Name varchar(60), Address varchar(60), ManagerID varchar(60) , JobTitle varchar(60), 
CertifiedFor varchar(60), StartDate DATE, Salary DECIMAL(30, 2));
...
create table CustomerServiceSchedule(ServiceScheduleID varchar(60), CustomerID varchar(60), ServiceTypeID varchar(60), 
EmployeeID varchar(60), StartDateTime DATE, ActualDuration DECIMAL(30, 0), Status CHAR(1));
